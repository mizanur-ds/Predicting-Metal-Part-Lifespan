...
models = ['Polynomial Ridge Regression', 'Random Forest']
scores = [0.8147, 0.6915]
...
# Data
model_1 = ['Polynomial Ridge Regression', 'Random Forest']
scores = [0.8147, 0.6915]
model_2 = ['Logistic Regression', 'Artificial Neural Network']
accuracy = [0.24, 0.56]
...
ax[0].bar(model_1, scores, color=['blue', 'green'])
ax[0].set_ylabel('R2 Score')
ax[0].set_title('Model Performance Comparison (Regression)')
ax[0].set_ylim(0, 1)

# Classification model plot
ax[1].bar(model_2, accuracy, color=['orange', 'purple'])
ax[1].set_ylabel('Accuracy')
ax[1].set_title('Model Performance Comparison (Classification)')
ax[1].set_ylim(0, 1)
